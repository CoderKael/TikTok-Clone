      ...
      <div className='bg-white rounded-lg xl-h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6 w-[60%]'>
        <div >
          ...
          <div className='flex flex-col gap-3 pb-10'>
            ...
            <select onChange={(e) => setCategory(e.target.value)} className='outline-none border-2 border-gray-200 text-md capitalize lg:p-4 p-2 rounded cursor-pointer'>{topics.map((topic) => (
